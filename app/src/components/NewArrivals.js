  ...
  return (
    ...
    >
      <div className="pt-16   flex flex-col justify-center items-center text-center">
        <h1 className="text-4xl xl:text-4xl tracking-[0.3rem] superior mb-8">
          New Arrivals
        </h1>
        ...
        <div className=" flex flex-col space-y-12 sm:space-y-4 lg:space-y-12">
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 space-x-0 md:space-x-4 lg:space-x-4 justify-center items-center">
            <div className="hidden lg:block mx-4 col-span-2 w-[22.5rem] xl:w-[25rem] h-[33.875rem] mb-8 lg:mb-0 xl:h-[37.5rem] relative">
            ...
            <div className="hidden lg:block mx-4 col-span-2 h-[33.875rem] w-[22.5rem] xl:w-[25rem] xl:h-[37.5rem] relative mt-24">
              <div className=" w-full  h-full  object-cover overflow-hidden">
                <LazyLoadImage
                  src={
            ...
            <div className="hidden lg:block mx-4 col-span-2 h-[33.875rem] w-[22.5rem] xl:w-[25rem] xl:h-[37.5rem] relative ">
              <div className=" w-full  h-full  object-cover overflow-hidden">
            ...
            <div className="lg:hidden col-span-2 w-[22.5rem]  h-[33.875rem] mx-12 relative mb-4">
              <div className=" w-full h-full  object- overflow-hidden rounded-md">
                <LazyLoadImage
                  src={
                    "https://res.cloudinary.com/dvywdmp9y/image/upload/v1665195068/New_Arrivals_1_zlqtfk.jpg"
                  }
            ...
            <div className="hidden md:block lg:hidden col-span-2 w-[22.5rem]  h-[33.875rem] relative mb-4 mt-24">
              <div className=" w-full h-full  object- overflow-hidden rounded-md new-arrival-img">
                <LazyLoadImage
                  src={
                    "https://res.cloudinary.com/dvywdmp9y/image/upload/v1665195056/New_Arrivals_3_bvqcca.jpg"
                  }
            ...
            <div className="hidden lg:block mx-4 col-span-2 lg:col-span-1 self-start  tracking-[0.3rem] superior uppercase pt-[2rem] lg:pt-[12rem] px-4 text-center ">
              <h1 className="text-4xl xl:text-4xl font-bold mb-4 lg:mb-8">
                Summer
              </h1>
              <h1 className="text-4xl xl:text-4xl font-bold mb-4 lg:mb-8">
                2022
              ...
              <Link
                to="/men/"
                className="text-4xl xl:text-4xl font-bold cursor-pointer underline-none hover:text-gray-600"
              >
                Men
              </Link>
            </div>
          ...
          {/* SECOND ONE */}
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 space-x-0 md:space-x-4 lg:space-x-4 justify-center items-center">
            <div className="hidden lg:block mx-4 col-span-2 lg:col-span-1 self-start tracking-[0.3rem] superior uppercase mb-0 pt-[12rem] text-center">
              <h1 className="text-4xl xl:text-4xl font-bold mb-8">Summer</h1>
              <h1 className="text-4xl xl:text-4xl font-bold mb-8">2022</h1>
              <Link
                to="/women/"
                className="text-4xl xl:text-4xl font-bold cursor-pointer hover:text-gray-600 text-center"
              >
                Women
              </Link>
            </div>
            <div className="hidden lg:block mx-4 col-span-2 w-[22.5rem] xl:w-[25rem] h-[33.875rem] xl:h-[37.5rem] relative ">
              <div className=" w-full h-full  object- overflow-hidden">
                <LazyLoadImage
                  src={
            ...
            <div className="lg:hidden col-span-4 self-start tracking-[0.3rem] superior uppercase mb-4 pt-[2rem] text-center">
              <h1 className="text-4xl xl:text-4xl font-bold  mb-4">Summer</h1>
              <h1 className="text-4xl xl:text-4xl font-bold mb-4">2022</h1>
              <Link
                to="/women/"
                className="text-4xl xl:text-4xl font-bold cursor-pointer hover:text-gray-600 text-center"
              >
